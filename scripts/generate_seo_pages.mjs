...
function productPage(product) {
  ...
  return '<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">' +
    ...
    '<a class="btn" href="' + site + '/app/#/product/' + encodeURIComponent(slug) + '">View and order online</a><a class="btn secondary" href="' + site + '/app/#/concierge">Help me choose</a>' + variantHtml + '</div></div>' + sections + '</main></div>' +
