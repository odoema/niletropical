  ...
  static Future<Map<String, dynamic>> createOrder({
    ...
    final res = await SupabaseService.client.rpc(
      ...
      params: {
        ...
        // address_line (plus optional district/city/area/etc.).
        // A bare string is valid jsonb but has no address_line key,
        // which the function reads as blank and rejects with
